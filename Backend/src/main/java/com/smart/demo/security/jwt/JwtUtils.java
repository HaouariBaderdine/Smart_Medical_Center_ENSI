package com.smart.demo.security.jwt;
...
public class JwtUtils {
	...
	@Value("${smart.app.jwtCookieName}")
	private String jwtCookie;

	public String getJwtFromCookies(HttpServletRequest request) {
		jakarta.servlet.http.Cookie cookie = WebUtils.getCookie((jakarta.servlet.http.HttpServletRequest) request, jwtCookie);
		if (cookie != null) {
