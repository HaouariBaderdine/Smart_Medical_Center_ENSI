...
public class AdviceController {
	...
	public ResponseEntity<Advice> createAdvice(@RequestBody Advice advice) {
		try {
			Advice _advice = adviceRepository.save(new Advice(advice.getEtat(), advice.getType(),
					advice.getDescription(), advice.getCreatedAt(), advice.getDemandeur(), advice.getMedecin()));
